...
class Order(models.Model):
    ...
    deliveryChoice = (('free', 'free'),
                      ('express', 'express'), ('ordinary', 'ordinary'))
    paymentChoice = (('online', 'online'),
                     ('someone', 'someone'))
    deliveryType = models.CharField(max_length=15, choices=deliveryChoice, default='free', blank=True, null=True)
    paymentType = models.CharField(max_length=15, choices=paymentChoice, default='online', blank=True, null=True)
    ...
    address = models.CharField(max_length=200, blank=True, null=True, default='Lenina street, 41, 310 apartment')
    totalCost = models.DecimalField(default=0, decimal_places=2, max_digits=10, blank=True, null=True)
